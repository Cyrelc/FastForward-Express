...
class BillCollector {
	public function Collect($req, $pickupAddressId, $deliveryAddressId, $charge_id) { 
		...
		return [
			...
			'pickup_account_id' => $req->pickup_address_type == "pickup_account" ? $req->pickup_account_id : null,
			'pickup_address_id' => $pickupAddressId,
			'delivery_account_id' => $req->delivery_address_type == "delivery_account" ? $req->delivery_account_id : null,
			'delivery_address_id' => $deliveryAddressId,
			'charge_reference_value' => $req->charge_type == 'account' ? $req->charge_reference_value : null,
			'pickup_reference_value' => $req->pickup_address_type == 'pickup_account' ? $req->pickup_reference_value : null,
			'delivery_reference_value' => $req->delivery_address_type == 'delivery_account' ? $req->delivery_reference_value : null,
