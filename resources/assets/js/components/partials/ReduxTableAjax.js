                        ...
                        <Card.Footer>
                            <ReactTabulator
                                ...
                                ajaxResponse={(url, params, response) => {
                                    console.log({url: url, params: params, response: response})
                                ...
                                options={{
                                    ajaxURL:this.props.dataUrl,
                                    ajaxLoaderLoading:'<h4>Requesting data, please wait... <i class="fas fa-spinner fa-spin"></i></h4>',
                                    pagination:true,
                                    paginationMode:'remote',
                                    paginationSize: 25,
                                    paginationInitialPage: 4,
                                    sortMode:'remote'
                                }}
                                placeholder='No results match the currently selected criteria. Please broaden your search and try again'
                            />
                            {/* <ReactTabulator
                                ref={this.state.tableRef}
                                ajaxURL={this.props.dataUrl}
                                ...
                                minHeight='55vh'
                                options={{
                                    ajaxLoaderLoading:'<h4>Requesting data, please wait... <i className="fas fa-spinner fa-spin"></i></h4>',
