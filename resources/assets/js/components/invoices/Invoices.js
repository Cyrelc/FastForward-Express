...
const columns = [
    ...
    {title: 'Invoice ID', field: 'invoice_id', formatter: cell => fakeLinkFormatter(cell), formatterParams:{type:'fakeLink', urlPrefix:'/app/invoices/view/'}, sorter:'number'},
    {title: 'Account ID', field: 'account_id', formatter: cell => fakeLinkFormatter(cell), formatterParams:{type:'fakeLink', urlPrefix:'/app/accounts/edit/', labelField:'account_number'}},
    {title: 'Account Number', field: 'account_number', formatter: cell => fakeLinkFormatter(cell), formatterParams:{type:'fakeLink', urlPrefix:'/app/accounts/edit/N'}, visible: false},
    {title: 'Account', field: 'account_id', formatter: (cell, formatterParams) => fakeLinkFormatter(cell, formatterParams), formatterParams:{type:'fakeLink', labelField:'account_name', urlPrefix:'/app/accounts/edit/'}},
