...
const columns = [
    ...
    {title: 'Account Number', field: 'account_number', formatter: 'link', formatterParams:{urlPrefix:'/app/accounts/edit/N'}},
    {title: 'Account', field: 'account_id', formatter: 'link', formatterParams:{labelField:'account_name', urlPrefix:'/app/accounts/edit/'}},
