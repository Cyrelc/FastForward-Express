        ...
        makeAjaxRequest(fetchUrl, 'GET', null, data => {
            ...
            if(params.action === 'edit' || params.action === 'view') {
                ...
                setup = {...setup,
                    ...
                    deliveryEmployee: data.bill.delivery_driver_id ? data.employees.find(employee => employee.employee_id === data.bill.delivery_driver_id) : '',
                    ...
                    pickupEmployee: data.bill.pickup_driver_id ? data.employees.find(employee => employee.employee_id === data.bill.pickup_driver_id) : '',
