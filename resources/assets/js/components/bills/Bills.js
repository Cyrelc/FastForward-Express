...
const columns = [
    ...
    {title: 'Delivery Driver', field: 'delivery_employee_id', formatter: 'link', formatterParams:{labelField:'delivery_employee_name', urlPrefix:'/employees/edit/'}, visible: false},
    ...
    {title: 'Pickup Driver', field: 'pickup_employee_id', formatter: 'link', formatterParams:{labelField:'pickup_employee_name', urlPrefix:'/employees/edit/'}},
