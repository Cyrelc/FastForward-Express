...
<!-- Pickup -->
        <div class='col-md-6'>
            @include('partials.pickup_delivery', ['prefix' => 'pickup', 'title' => 'Pickup', 'address' => $model->pickupAddress, 'account_id' => $model->bill->pickup_account_id, 'date' => $model->bill->pickup_date])
        </div>
<!-- Delivery -->
        <div class='col-md-6'>
            @include('partials.pickup_delivery', ['prefix' => 'delivery', 'title' => 'Delivery', 'address' => $model->deliveryAddress, 'account_id' => $model->bill->delivery_account_id, 'date' => $model->bill->delivery_date])
        </div>
    </div>
<!-- Piece Information -->
