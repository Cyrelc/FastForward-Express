...
<div class='row'>
    ...
    <div class='col-md-12'>
        <div class='row' style='padding: 20px 100px'>
            ...
            <div class='col-md-10 offset-md-2 employee-profile'>
                <h3 style='text-align: right'>Vicky Nelson - Office Accounting Personnel</h3>
            ...
            <div class='col-md-10 offset-md-2 employee-profile'>
                <h3 style='text-align: right'>Justin Nelson - Dispatch</h3>
            ...
            <div class='col-md-10 employee-profile'>
                <h3>Riley Nelson - Office receptionist and backup dispatch</h3>
                <h5>Riley, Ritchie's youngest son, is Fat Forward's office receptionist, taking delivery requests from existing clients and answering calls from new clients, sales representatives, and numerous others.</h5>
