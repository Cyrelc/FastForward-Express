...
<!-- start date -->
        <div class="col-lg-4 bottom15">
            <div class="input-group">
                ...
                <input type='text' id="start_date" onblur='getDriversToManifest()' class="form-control" name='start_date' value="{{date("F d, Y", $model->start_date)}}" />
...
<!-- end date -->
        <div class="col-lg-4 bottom15">
            <div class="input-group">
                ...
                <input type='text' id="end_date" onblur='getDriversToManifest()' class="form-control" name='end_date' value="{{date("F d, Y", $model->end_date)}}" />
                <span class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                </span>
            </div>
